  ...
  return (
    <main className='home'>
      ...
      <div className="search">
        <input type="text" placeholder='Search here by Name' onChange={e => setsearch(e.target.value)} />
      ...
      {search &&
        <div className="table">
          ...
          {searchResult.length !== 0 ? <div className="table-col">
            ...
            {header[0].message && <div className="table-header">{header[0].message.title}</div>}
            {header[0].created_at && <div className="table-header">{header[0].created_at.title}</div>}
          </div> : null}
